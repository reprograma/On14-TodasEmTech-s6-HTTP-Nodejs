...
console.log("****************************************************");
console.log("Atividade de Andréa Carvalho");
console.log("****************************************************");
for (let i = 0; i <= filmes.length - 1; i++) {
  let cinema = filmes[i]; //trata-se de um array com vários objetos, ao contrário do exemplo das cores
  console.log(
    //dúvida: quando coloquei console.log(filmes[i]), não aceitou, só aparecia letra por letra
...
for (let j = 0; j <= filmes.length - 1; j++) {
  let cinema2 = filmes[j];
  lista.push(cinema2.Genre);
  lista.push(cinema2.Actors);
  //console.log(`Genre: ${cinema2.Genre};\nActors: ${cinema2.Actors}`);
  console.log(lista);
  console.log(
    "*********************************************************************"
  );
